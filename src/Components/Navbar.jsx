        ...
        <div className="navbar-end">
          {user ? (
            <Link
              ...
              to="/signIn"
              className="btn bg-blue-600 text-white hover:bg-blue-950 transform hover:-translate-y-1 transition duration-200"
            >
              Sign Out
            </Link>
          ) : (
            <Link
              to="/signIn"
              className="btn bg-blue-500 text-white hover:bg-blue-950 transform hover:-translate-y-1 transition duration-200"
            >
              Sign In
            </Link>
          )}
